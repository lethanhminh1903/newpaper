...
if(isset($_POST['ok'])) {
    ...
    $pass= "";
    $tale_name= "test3";
    $connect= mysql_connect($host,$user,$pass,$tale_name) or die('Lỗi');
    $query= "insert into admin1 (username,password) value ('{$a}','{$b}')";
                    ...
                    <div class="form-items">
                        ...
                        <form>
                            ...
                            <div class="form-button">
                                <button id="submit" type="submit" name="ok" class="ibtn">Register</button>
                            </div>
                        </form>
